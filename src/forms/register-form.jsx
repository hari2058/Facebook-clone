...
const registerFormSchema = z.object(
    {
        firstname: z.string({ required_error: "Firts name is requred." })
                ...
                <div className="grid place-items-center  h-dvh w-screen bg-[rgb(242,244,247)]">
                    ...
                    <div className="bg-white p-5 shadow-[inset_0px_0px_0px_1px_rgba(0,0,0,0.2)]  w-[440px] h-[610.94px] rounded-sm ">
                        ...
                        <div className="px-[10px] py-[16px] ">
                            ...
                            <p className="text-sm opacity-80 text-center mb-2">It's quick and easy.</p>
                        </div>

                        <hr className="opacity-50 mb-4" />
                        <form
                            onSubmit={handleSubmit(onSubmit)} className="grid gap-1">
                            {/* name input area */}
                            <div className=" grid grid-cols-2 gap-2 mb-2">
                                <input
                                    name="firstname"
                                    placeholder="First Name" type="text " className="border rounded-sm h-[36px] p-2"
                                    {...register("firstname")} />
                                <input
                                    name="lastname"
                                    {...register("lastname")}
                                    placeholder="Last Name" type="text " className="border rounded-sm p-2 h-[36px]"
                                />
                            ...
                            <div className="mb-2">
                                ...
                                <div className="flex justify-between">
                                    <select
                                        {...register("day")}
                                        name="day" id="day" className="w-[125px] h-[36px] border rounded-sm ">
                                    ...
                                    {errors.day && <div className="text-red-600">{errors.day.message}</div>}
                                    <select
                                        {...register("month")}

                                        name="month" id="month" className="w-[125px] h-[36px] border rounded-sm ">
                                    ...
                                    {errors.month && <div className="text-red-600">{errors.month.message}</div>}

                                    <select
                                        {...register("year")}
                                        name="year" id="year" className="w-[125px] h-[36px] border rounded-sm ">
                                    ...
                                    {errors.year && <div className="text-red-600">{errors.year.message}</div>}
                            ...
                            <div >
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <label className="border rounded-sm w-[125px] h-[36px]  flex justify-around items-center"
                                        {...register("gender")}
                                    >
                                        Custom
                            ...
                            <div>
                                <input
                                    name="email"
                                    {...register("email")} type="text" className="border w-full mt-2 h-[36px] rounded-sm mb-2"
                            ...
                            <Link to="/">
                                <span className="text-blue-500  flex justify-center">Already have an account?</span>
                            </Link>
